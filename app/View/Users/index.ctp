...
<title>COSON Licensing Application Platform [CLAP]</title>
...
<h2>COSON Licensing Application Platform <span>[CLAP]</span></h2>
...
<h4 style='color:white; line-height: 25px;'>In order to make it easy and stress free for users of music to get the licence required to legally play music in their business environment and facilities and pay for the use of the music without leaving the comfort of their businesses, COSON welcomes you to CLAP! the easy to use licensing Platform. </h4>
...
<div class="row">
<div class="col-sm-9">
<h2>Welcome to <span>COSON Licensing Application Platform [CLAP]</span> </h2><h3>The easy to use licensing Platform</h3>
<p style='color:#454545;'>A few clicks on this Platform and in less than five minutes, you are on your way to complying with the law and obtaining a music copyright licence. The COSON music copyright licence gives you the freedom to play both local and foreign music in your business as you like, for your enjoyment and that of your customers.
...
<form role="form" action="<?php echo $this->webroot;?>users/signUp" method="post" id="licence" class="f1">
...
<div class="row">
<label class="col-md-4 control-label">Number of <span class="vehicle"> vehicle</span> (s) :</label> <div class="col-md-8 summaryVehiclesNumber" id="summaryVehiclesNumber">

</div>
<input type="hidden" name="data[Payment][number_of_vehicles]" value="" id="inputVehiclesNumber" />
</div>
<div class="row">
<label class="col-md-4 control-label">Number of <span class="userCat"> Category</span> (s) :</label> <div class="col-md-8 summaryUserCategoryNumber" id="summaryUserCategoryNumber">
...
<input type="hidden" name="inter" value="" id="interswitchinput" />
</div>
<div class="f1-buttons">
<button type="button" class="btn btn-previous">Previous <i class="fa fa-arrow-left"></i></button>
<button type="submit" onclick="submit_form();"  class="btn btn-submit">Make Payment</button>
...
<!--<input type="text" id="inputAmounts" value="1000">-->
</body>
...
var redirect = "https://www.clapng.com/makePayment/"+email;
...
//    $("#send_comment"+no).submit();
    ...
    $("#licence").on('submit',(function(e) {
       ...
       e.stopImmediatePropagation();
        ...
        $.ajax({
            url: "<?php echo $this->webroot;?>users/signUp", // Url to which the request is send
