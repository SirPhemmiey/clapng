  ...
  echo "<div class='alert alert-danger alert-dismissable'>";
    ...
    <div class="form-group">
        ...
        <label for="company_name" class="control-label col-md-4">Company Name   : </label>
            <div class="col-md-5">
                <input type="text" id="company_name" name="data[User][company_name]" class="form-control" value="<?php if(isset($company_name)){ echo $company_name;} else echo "";?>">
            </div>
            <span class="showError" style="display:none; color:red;">This field cannot be blank </span>
        </div>
    </div>
     <div class="form-group">
        <div class="row">
        <label for="contact_person" class="control-label col-md-4">Contact Person   : </label>
            <div class="col-md-5">
              <input type="text" id="contact_person" name="data[User][contact_person]" class="form-control" value="<?php if(isset($company_name)){ echo $contact_person;} else echo "";?>">
            </div>
            <span class="showError" style="display:none; color:red;">This field cannot be blank </span>
        </div>
        </div>
   <div class="form-group">
        ...
        <label for="contact_person" class="control-label col-md-4">Phone number   : </label>
            <div class="col-md-5">
              <input type="text" id="phone_number" name="data[User][phone_number]" class="form-control" value="<?php if(isset($company_name)){ echo $phone_number;} else echo "";?>">
            </div>
            <span class="showError" style="display:none; color:red;">This field cannot be blank </span>
        </div>
        </div>
<div class="form-group">
        ...
        <label for="email_address" class="control-label col-md-4">Email Address   : </label>
            <div class="col-md-5">
               <input type="text" id="email_address" name="data[User][email_address]" class="form-control" value="<?php if(isset($company_name)){ echo $email_address;} else echo "";?>">
            </div>
            <span id="showError" style="display:none; color:red;">This field cannot be blank </span>
        </div>
        </div>
